    ...
    return (
      <div class="eventcard-slider__item swiper-slide">
        <div class="eventcard-slider__img">
          <img src={event["image"]} alt="Ball 2021" />
        </div>
        <div class="eventcard-slider__content">
          <span class="eventcard-slider__code">{event["date"]}</span>
          <div class="eventcard-slider__title">{event["name"]}</div>
          <div class="eventcard-slider__text">{event["description"]}</div>
              ...
              <Col>
                <div class="eventcard-slider eventcard-bg-wrapper" >
                  <div class="eventcard-slider__wrp swiper-wrapper container">
                    {eventsData["upcoming"].map(event => this.toSwiperCard(event))}
                  </div>
